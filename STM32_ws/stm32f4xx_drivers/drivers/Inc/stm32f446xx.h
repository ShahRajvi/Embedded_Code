...
typedef struct{
	...
	__vo uint32_t I2C_OAR1;		// I2C Own address register. Address offset: 0x08
	__vo uint32_t I2C_OAR2;		// I2C Own address register. Address offset: 0x0C
	__vo uint32_t I2C_DR;		// I2C data register. Address offset: 0x10
	__vo uint32_t I2C_SR1;		// I2C status register. Address offset: 0x14
	__vo uint32_t I2C_SR2;		// I2C status register. Address offset: 0x18
...
/***********************************************************************************************************
 *			 I2C: Bit position definition for I2C registers
 ***********************************************************************************************************/
/*

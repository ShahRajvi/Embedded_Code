...
typedef struct{
	uint8_t SPI_DeviceMode;	//MSTR bit of CR1 register
	uint8_t SPI_BusConfig;	//BIDI OE or BIDI MODE bit of CR1 register
...
//#define SPI_BUS_CONFIG_Simplex_TXONLY	3 // This is the same has full duplex.
...
#define SPI_SR_TXE_FLAG 		(1 << SPI_SR_TXE)	// Flag for TXE bit of SR register
